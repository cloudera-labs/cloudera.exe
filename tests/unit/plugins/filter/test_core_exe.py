...
class TestFilterModule(unittest.TestCase):
    ...
    def test_combine_onto(self):
        ...
        source_dict = {"foo": "bar", "gaz": "blaz", "nested": {"duz": "ferr"}}
        target_dict = {"gaz": "blergh", "derr": "zaar", "nested": {"wuz": "gug"}}
        ...
        self.assertDictEqual(expected_results, test_filter([source_dict, target_dict]))
